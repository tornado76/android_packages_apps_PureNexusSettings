...
public class BatteryFragment extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBatteryBarColor.setSummary(mBatteryBarColor.getSummaryText() + ColorPickerPreference.convertToARGB(Settings.System.getInt(resolver,
                     Settings.System.STATUSBAR_BATTERY_BAR_COLOR, mBatteryBarColor.getPrefDefault())));
        mBatteryBarColor.setNewPreviewColor(Settings.System.getInt(resolver, Settings.System.STATUSBAR_BATTERY_BAR_COLOR, mBatteryBarColor.getPrefDefault()));
