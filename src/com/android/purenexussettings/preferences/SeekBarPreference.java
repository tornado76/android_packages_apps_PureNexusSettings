...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private static final String PURE = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        ...
        mMinValue = attrs.getAttributeIntValue(PURE, "minimum", 0);
        mUnitsLeft = getAttributeStringValue(attrs, PURE, "unitsLeft", "");
        String units = getAttributeStringValue(attrs, PURE, "units", "");
        mUnitsRight = getAttributeStringValue(attrs, PURE, "unitsRight", units);
        ...
        try {
            String newInterval = attrs.getAttributeValue(PURE, "interval");
            if(newInterval != null)
