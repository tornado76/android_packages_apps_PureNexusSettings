...
public class CarrierLabelFragment extends PreferenceFragment implements OnPreferenceChangeListener {

    public CarrierLabelFragment(){}

    private static final String TAG = "CarrierLabelFragment";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.carrierlabel_fragment);
